...
const childEnv={PATH:process.env.PATH??'',HOME:process.env.HOME??'',TMPDIR:process.env.TMPDIR??'/tmp',DATABASE_URL:dbUrl('housemed_worker'),READ_DATABASE_URL:dbUrl('housemed_reader'),HOUSEMED_API_TOKEN:token,HOST:'127.0.0.1',PORT:String(port),SUPABASE_SECRET_KEY:'',SUPABASE_PROJECT_REF:'housemed-e2e-fixture',HOUSEMED_E2E_SOCKET:socket,CRAWL_DELAY_MS:'5000',HOUSEMED_RXNORM_DISABLED:'1',NODE_OPTIONS:''};
