...
export const prescriptionInput=z.object({action:z.enum(['chat','confirm','prepare']),request_id:z.string().uuid(),message:z.string().max(4000).default(''),image:photo.optional(),draft_id:z.string().uuid().optional(),member_id:z.string().uuid().optional(),fields:fields.optional()}).strict();
