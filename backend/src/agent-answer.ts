...
function purchaseUrl(raw:unknown){
 ...
 if(url.protocol!=='https:'||!['www.healthwarehouse.com','healthwarehouse.com','www.costplusdrugs.com','costplusdrugs.com','www.costco.com','costco.com','rx.costco.com'].includes(url.hostname)||url.username||url.password||url.port)throw Error('INVALID_SOURCE_URL');
 return raw;
}
