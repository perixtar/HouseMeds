...
const publicHost=(h:string)=>h.endsWith('.pooler.supabase.com')||h.endsWith('.supabase.co')||['www.healthwarehouse.com','healthwarehouse.com','www.costplusdrugs.com','costplusdrugs.com','www.costco.com','costco.com','rx.costco.com','us-central1-costplusdrugs-publicapi.cloudfunctions.net','rxnav.nlm.nih.gov'].includes(h);
