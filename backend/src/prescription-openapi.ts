...
export const prescriptionOpenApi = {
  ...
  paths: {
    ...
    '/v1/prescription-chat': {post: {summary: 'Add a household member, extract a photo, select a member, prepare manual fields, or confirm a save',
